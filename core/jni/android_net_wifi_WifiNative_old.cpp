...
static jboolean android_net_wifi_doBooleanCommand(JNIEnv* env, jobject, jstring jIface,
        jstring jCommand)
{
    return doBooleanCommand(env, jIface, jCommand);
}

static jint android_net_wifi_doIntCommand(JNIEnv* env, jobject, jstring jIface, jstring jCommand)
{
    return doIntCommand(env, jIface, jCommand);
}

static jstring android_net_wifi_doStringCommand(JNIEnv* env, jobject, jstring jIface,
    jstring jCommand)
{
    return doStringCommand(env, jIface, jCommand);
}

...
public final class DevicePerformanceTool { 
	...
	*/
	...
	private static DevicePerformanceTool mDevicePerformanceTool = null;

	public static DevicePerformanceTool getInstance() {
        if(mDevicePerformanceTool == null)
            mDevicePerformanceTool = new DevicePerformanceTool();
        
        return mDevicePerformanceTool;
	}
    ...
    public void initData() {
        ...
        int value = 0;
        if (mLevelsMap.get(PackageManager.HARDWARE_ACC_MODE_NORMAL) != null) {
            value = mLevelsMap.get(PackageManager.HARDWARE_ACC_MODE_NORMAL);
        }

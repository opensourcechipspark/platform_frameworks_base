...
*/
    ...
    int RIL_REQUEST_SET_AUDIO_MODE = 114;
    int RIL_REQUEST_GET_AUDIO_MODE = 115;
    int RIL_REQUEST_SET_AUDIO_MODE_VOLUME = 116;
    int RIL_REQUEST_GET_AUDIO_MODE_VOLUME = 117;

...
public class WifiMonitor {
   ...
   /* Network connection completed */
    ...
    public WifiMonitor(StateMachine wifiStateMachine, WifiNative wifiNative) {
        ...
        mMonitoring = false;
		mWifiMonitorSingleton = new WifiMonitorSingleton();

        mWifiMonitorSingleton.getMonitor().registerInterfaceMonitor(mInterfaceName, this);
    }

    public void startMonitoring() {
        mWifiMonitorSingleton.getMonitor().startMonitoring(mInterfaceName);
    }

    public void stopMonitoring() {
        mWifiMonitorSingleton.getMonitor().stopMonitoring(mInterfaceName);
    }

    public void stopSupplicant() {
        mWifiMonitorSingleton.getMonitor().stopSupplicant();
    }

    public void killSupplicant(boolean p2pSupported) {
        mWifiMonitorSingleton.getMonitor().killSupplicant(p2pSupported);
    }

    private class WifiMonitorSingleton {
        private Object sSingletonLock = new Object();
        private WifiMonitorSingleton sWifiMonitorSingleton = null;
        ...
        WifiMonitorSingleton getMonitor() {
